...
namespace MFiles.Internal.Win32PInvoke.Constants
{
   ...
   /// Each user's privileges include those granted to the user and to the groups to which the user belongs.
	...
	/// Use the LookupPrivilegeValue function to determine the LUID on the local system that corresponds to a privilege constant. 
	...
	public static class PrivilegeConstants
	{
		...
		/// Any access request other than write is still evaluated with the ACL. Additionally, this privilege enables you to set any valid user or group SID as the owner of a file. 
